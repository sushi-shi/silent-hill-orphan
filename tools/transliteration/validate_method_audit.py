...
FIELD_REQUESTS = [
    ...
    ("M", "Application", "appInited", "Z", "ApplicationState", "app_inited"),
...
def print_declaration_entries() -> None:
    ...
    for item in (
        ...
        "variant:ApplicationExitError::MidletNull",
        "variant:ApplicationExitError::NotifyException",
        "variant:ApplicationExitError::NotifyUncaught",
        "enum:ApplicationExitError",
        ...
        "variant:ApplicationRmsGetCallError::RecordStoreNotFound",
        "variant:ApplicationRmsGetCallError::RecordStore",
        "variant:ApplicationRmsGetCallError::OtherException",
        "variant:ApplicationRmsGetCallError::Uncaught",
        "enum:ApplicationRmsGetCallError",
...
def print_entries() -> None:
    requested = [
        ...
        ("M", "Application", "exit", "()V", "exit()", "fn:application_exit"),
